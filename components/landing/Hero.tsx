...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[90vh] bg-[#05070c] text-white pt-4 pb-10 overflow-hidden font-sans flex flex-col justify-between">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex flex-col justify-center items-center">
        
        {/* Main Grid: Perfectly Balanced (3 cols / 6 cols / 3 cols) for Absolute Center Watch */}
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 items-center mb-6">
          
          {/* LEFT SPACER (Col 3 to balance the right photo Col 3) */}
          <div className="hidden lg:block lg:col-span-3" />

          {/* CENTER COLUMN: The Iconic Glowing Skeleton Watch HUD (Col 6 - Strictly Centered) */}
          <div className="lg:col-span-6 flex flex-col items-center justify-center py-1">
            
            {/* Main Center Container with Glow */}
            <div className="relative flex flex-col items-center group w-full max-w-[400px]">
              ...
              <div className="relative w-[290px] h-[290px] sm:w-[350px] sm:h-[350px] md:w-[380px] md:h-[380px] rounded-full p-2 bg-gradient-to-b from-slate-700 via-slate-900 to-black shadow-2xl shadow-black border-4 border-slate-700/80 flex items-center justify-center">
          ...
          <div className="lg:col-span-3 flex flex-col justify-start items-center lg:items-end">
            ...
            <div className="relative rounded-2xl p-1 bg-gradient-to-br from-emerald-500/40 via-cyan-500/20 to-slate-800 shadow-2xl shadow-black/80 group overflow-hidden w-full max-w-[260px]">
        ...
        {/* 🌟 3 Feature Cards (Tableaux) - Strictement et rigoureusement centrés au milieu de l'écran */}
        <div className="w-full flex justify-center items-center px-4 mt-2">
          <div className="w-full max-w-3xl grid grid-cols-1 sm:grid-cols-3 gap-3.5">
            
            {/* Tableau 1: Rappels Vocaux IA */}
            <div className="p-3.5 sm:p-4 rounded-xl bg-slate-900/85 border border-slate-800 hover:border-emerald-500/40 backdrop-blur-xl shadow-lg shadow-black/50 transition-all duration-300 hover:-translate-y-0.5 group">
            ...
            <div className="p-3.5 sm:p-4 rounded-xl bg-slate-900/85 border border-slate-800 hover:border-cyan-500/40 backdrop-blur-xl shadow-lg shadow-black/50 transition-all duration-300 hover:-translate-y-0.5 group">
            ...
            <div className="p-3.5 sm:p-4 rounded-xl bg-slate-900/85 border border-slate-800 hover:border-teal-500/40 backdrop-blur-xl shadow-lg shadow-black/50 transition-all duration-300 hover:-translate-y-0.5 group">
