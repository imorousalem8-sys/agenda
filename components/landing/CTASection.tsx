...
export default function CTASection() {
  return (
    <section className="py-20 sm:py-28 bg-slate-950 text-white relative overflow-hidden border-t border-slate-800/80">
      
      {/* Aurora Mesh Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-gradient-to-r from-cyan-600/25 via-indigo-600/30 to-purple-600/25 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {/* Shimmer Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-400/30 text-cyan-300 text-xs font-bold uppercase tracking-wider mb-6 backdrop-blur-md">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
          <Link
            href="/register"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-9 py-4 rounded-full text-base font-bold text-slate-950 bg-gradient-to-r from-cyan-400 via-teal-300 to-cyan-400 hover:from-cyan-300 hover:to-teal-200 shadow-2xl shadow-cyan-500/30 hover:shadow-cyan-500/50 hover:scale-[1.03] transition-all duration-200"
          >
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs text-slate-400 font-medium pt-6 border-t border-slate-800/80">
          ...
          <span className="flex items-center gap-1.5">
            <ShieldCheck size={15} className="text-cyan-400 stroke-[2.5]" />
